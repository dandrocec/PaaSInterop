...
public class InternalDomain
{
  ...
  */
  public void close(int varsMaxSize) throws IOException
  {
   ...
   // System.out.println("DEBUG name: " + name + ".java");
    
    // moj kod - dodavanje paketa i kamo će se pohraniti datoteka
    s = "package hr.org.foi.generated.aifiles;\n" + s;
    String fileDirectory = "D:\\DOKTORAT\\NetbeansProjects\\AiPlanningServices\\src\\java\\hr\\org\\foi\\generated\\aifiles\\";

    String fileLocation = fileDirectory + name;

    //-- Open the file with the appropriate name.
    BufferedWriter dest = new BufferedWriter(new FileWriter(fileLocation + ".java"));
   ...
   // System.out.println("DEBUG file location --> " + fileLocation);
    
    // dodan moj kod
    dest = new BufferedWriter(new FileWriter(fileLocation + ".txt"));
  ...
  */
  public void commandInitialize() throws IOException
  {
    ...
    //-- Open the file.
   // System.out.println("DEBUG --> open the file " + name + ".txt");
    ...
    src = new BufferedReader(new FileReader(fileLocation+ ".txt") );
  ...
  */
              ...
              throws IOException
  {
    ...
    String fileLocation = fileDirectory + probName;

    dest = new BufferedWriter(new FileWriter(fileLocation + ".java"));
  ...
  */
  public static void main(String[] args) throws Exception
  {
    ...
    if (args == null || args.length == 2 || args[0].substring(0, 2).equals("-r")) {
      if (args[0].equals("-r"))
        planNo = 1;
    ...
    if (args == null || ((args.length != 2) || planNo <= 0) && (args.length != 1))
    {
